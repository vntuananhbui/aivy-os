...
from connector.jira.tools import get_jira_tools as get_legacy_jira_tools
from connector.sharepoint.tools import get_sharepoint_tools as get_legacy_sharepoint_tools
from ai_adapters.connectors.jira import get_jira_tools as get_compat_jira_tools
from ai_adapters.connectors.sharepoint import get_sharepoint_tools as get_compat_sharepoint_tools
...
def test_legacy_sharepoint_tool_imports_reexport_ai_adapter_objects() -> None:
    ...
    assert get_compat_sharepoint_tools() == current
...
def test_legacy_jira_tool_imports_reexport_ai_adapter_objects() -> None:
    ...
    assert get_compat_jira_tools() == current
