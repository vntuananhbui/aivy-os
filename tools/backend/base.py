...
class BrowserService:
    ...
    async def _upgrade_html(self, url: str) -> str:
        ...
        from tools.backend.aiohttp import AiohttpBackend
        from tools.backend.crawl4ai import Crawl4aiBackend
        from tools.backend.jina import JinaReaderBackend
        from tools.backend.search_engine import SearchEngineBackend
