...
from ai.research.tools.search_state import _current_agent_var, _ws
...
def get_writer_tools() -> list:
    ...
    from ai.research.tools.socm_read import get_socm_read_tools
    from ai.research.tools.skill_catalog import list_skills, load_skill
    return [
