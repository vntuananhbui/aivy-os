"""openalex_work — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.openalex.org/works?search={query}&per-page={per_page}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['results']
_FIELDS = {'title': ['display_name'], 'url': ['id'], 'publication_year': ['publication_year'], 'doi': ['doi'], 'type': ['type']}
