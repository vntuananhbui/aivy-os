"""crossref_work — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.crossref.org/works?query={query}&rows={rows}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['message', 'items']
_FIELDS = {'title': ['title'], 'url': ['URL'], 'doi': ['DOI'], 'snippet': ['abstract'], 'citations': ['is-referenced-by-count']}
