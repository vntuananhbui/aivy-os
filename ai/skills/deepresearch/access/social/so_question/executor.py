"""so_question — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.stackexchange.com/2.3/search/advanced?site={site}&q={query}&pagesize={num_results}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['items']
_FIELDS = {'title': ['title'], 'url': ['link'], 'score': ['score'], 'answer_count': ['answer_count'], 'tags': ['tags']}
