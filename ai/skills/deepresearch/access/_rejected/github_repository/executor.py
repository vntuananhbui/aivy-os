"""github_repository — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.github.com/search/repositories?q={query}&per_page={num_results}'
_HEADERS = {'Accept': 'application/vnd.github.v3+json'}
_RESULT_PATH = ['items']
_FIELDS = {'title': ['full_name'], 'url': ['html_url'], 'snippet': ['description'], 'owner': ['owner', 'login']}
