"""openfoodfacts_product — agent-called public-API access skill (auto-generated)."""
...
from ai.skills.core.contract import SkillContext

logger = logging.getLogger(__name__)

_URL_TEMPLATE = 'https://world.openfoodfacts.org/cgi/search.pl?search_terms={query}&json=1&page_size={num_results}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['products']
_FIELDS = {'title': ['product_name'], 'id': ['code'], 'brand': ['brands'], 'url': ['url'], 'snippet': ['generic_name']}
