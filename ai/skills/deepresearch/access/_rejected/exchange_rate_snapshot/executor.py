"""exchange_rate_snapshot — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.frankfurter.app/latest?from={from}&to={to}&amount={amount}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = []
_FIELDS = {'amount': ['amount'], 'base': ['base'], 'date': ['date'], 'rates': ['rates']}
