"""hn_story — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://hn.algolia.com/api/v1/search?query={query}&tags={tags}&hitsPerPage={num_results}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['hits']
_FIELDS = {'title': ['title'], 'url': ['url'], 'author': ['author'], 'points': ['points'], 'num_comments': ['num_comments']}
