"""finance_search_result — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://query2.finance.yahoo.com/v1/finance/search?q={query}&quotesCount={limit}'
