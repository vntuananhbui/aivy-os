"""semantic_scholar_paper — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://api.semanticscholar.org/graph/v1/paper/search?query={query}&limit={num_results}&fields={fields}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['data']
_FIELDS = {'title': ['title'], 'snippet': ['abstract'], 'authors': ['authors'], 'year': ['year']}
