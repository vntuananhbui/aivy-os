"""quote_search_match — agent-called public-API access skill (auto-generated)."""
...
_URL_TEMPLATE = 'https://query2.finance.yahoo.com/v1/finance/search?q={query}&quotesCount={quotes_count}'
_HEADERS = {'Accept': 'application/json'}
_RESULT_PATH = ['quotes']
_FIELDS = {'symbol': ['symbol'], 'name': ['shortname'], 'exchange': ['exchDisp'], 'sector': ['sector'], 'industry': ['industry']}
