...
1. ``ai.tools.search.build_search_provider()`` — same provider quickchat's
...
2. ``ai.tools.backend.base.BrowserService`` — same fetch backend quickchat/deep-
...
Run: python3 ai/skills/global/access/aivy_search_stock/scripts/test_search_stock.py DPM VCB FPT
"""
